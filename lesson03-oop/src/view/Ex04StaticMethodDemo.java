...
public class Ex04StaticMethodDemo {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 + Các hàm phụ thuộc vào đối tượng gọi nó(đang gọi)
		   --> phụ thộc: mỗi đối tượng gọi hàm sẽ đưa ra kết quả khác nhau
		   --> non-static
		   
		 + Các hàm không phụ thuộc vào đối tượng gộ nó(đang gọi)  
	...
	// hàm phụ thuộc vào giá trị của tham số truyền vào
	// chp a, b mấy thì return sum a và b như vậy
