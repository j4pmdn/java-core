...
public class Ex03BasicCarAdvDemo {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 non-static
		   --> class gọi được không ? KHÔNG(khi nào khởi tạo đối tượng thì mới có thông tin cho thuộc tính non-static)
		...
		// hàm khởi tạo ko nên truyền giá trị cho thuộc tính static
		...
		// cập nhật cho tất cả các đối tượng, nhìn code dễ hiểu nhầm chỉ cập nhật cho c04
		// c04.setModel("MG");
