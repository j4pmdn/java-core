...
public class Ex01TestMainMethod {
	...
	/*
	 ...
	 System.out.print: in ra và ko xuống hàng
	...
	/*
	 ...
	 - 4 khả năng
	   + public: được phép gọi, truy cập từ bất ký class nào trong project
	   + private: được phép gọi, truy cập trong class hiện tại
	   + protected/default: được phép gọi, truy cập từ bất kỳ class nào trong package hiện tại
	 ...
	 + [parameters ...]: danh sách tham số(đầu vào của hàm)
	   . nếu bài toán, hàm ko cso input ko cần truyền tham số vào
	   . khai báo tham số, nhận kết quả giá trị từ chỗ gọi hàm
