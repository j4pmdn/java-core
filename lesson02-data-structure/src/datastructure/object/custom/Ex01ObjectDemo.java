...
public class Ex01ObjectDemo {
	...
	public static void main(String[] args) {
		// biến x đang trỏ đến ô nhớ có giá trị là 'x' ở stack
		char x = '^';
		int a = 5;
		...
		// Mong muốn
		// Thay vì khi in biến itA nó ra tên package, class @ địa chỉ thông qua hàm toString
		// Muốn: in biến itA --> in ra giá trị các thuộc tính ô nhớ mà itA đang trỏ đến
		...
		// --> tốn n để set giá trị cho từng thuộc tính
